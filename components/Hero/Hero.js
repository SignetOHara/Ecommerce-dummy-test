...
const Hero = () => {
  return (
    <div className="h-96 rounded-md overflow-hidden bg-cover bg-center relative">
      <Image
        src="https://res.cloudinary.com/dco37iiel/image/upload/v1635384469/good-times_kml7wm.jpg"
        alt="Hero Image"
        layout="fill"
        objectFit="cover"
      ...
      <div className="bg-gray-900 bg-opacity-60 flex items-center h-full absolute w-full z-10">
        <div className="px-10 max-w-xl">
          <h2 className="text-2xl text-white font-semibold">Get the best drinks for every occasion</h2>
